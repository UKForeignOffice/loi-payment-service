...
module.exports = {
    ...
    buildUkPayData: function(formFields, applicationDetail, application, usersEmail) {
        ...
        formFields.return_url = configGovPay.configs.resultURL
    ...
    additionalPaymentsAddBaseData: function (formFields, casebookRef, cost, email) {
        let moment = require('moment');

        formFields.amount = Math.round(cost * 1e2)
        formFields.reference = (casebookRef) ? casebookRef : moment().unix().toString()
